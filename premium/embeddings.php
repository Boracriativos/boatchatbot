...
class MeowPro_MWAI_Embeddings {
  ...
  function rest_vectors_sync( $request ) {
    try {
      ...
      return new WP_REST_Response([ 'success' => true, 'message' => $message, 'vector' => $vector ], 200 );
    }
    catch ( Exception $e ) {
      return new WP_REST_Response([ 'success' => false, 'message' => $e->getMessage() ], 500 );
    }
  ...
  function sync_vector( $vector = null, $postId = null, $envId = null ) {
    ...
    $dimensionsMismatch = (string)$env['ai_embeddings_dimensions'] !== (string)$vector['dimensions'];
